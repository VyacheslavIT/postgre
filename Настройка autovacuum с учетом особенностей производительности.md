...
Особых изменений нет, полагаю из-за небольшого количества записей в таблице. С дефолтовыми настройками tps = 825 с настройками из файла tps = 839 разница 14 транзакций в секунду.
