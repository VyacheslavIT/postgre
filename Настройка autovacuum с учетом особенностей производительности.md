...
Особых изменений нет, предположу из-за небольшого количества записей в таблице. С дефолтовыми настройками tps = 825 с настройками из файла tps = 839 разница 14 транзакций в секунду.
При увеличении коэффициента масштабирования на 100. С дефолтовыми настройками tps = 195 с настройками из файла tps =298 разница 103 транзакции в секунду.
