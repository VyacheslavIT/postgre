...
(1 row)
```
Данная таблица расположена в схеме public, права мы выдавали на схему testnm, по этому и нет прав чтения данной таблицы
...
Сначала снова выполняем GRANT SELECT ON ALL TABLES IN SCHEMA testnm TO readonly для существующих таблиц, после выполнения  появяться права на выполнение запроса select из таблицы t1, 
